...
<div class="container">
    <div class="col-md-12">
        <h3 class="page-header text-center">
            ...
            <span class="highlighted-text">REPORTE CONDUCTUAL ALUMNOS</span>
        </h3>
        ...
        <div class="input-group mb-3">
            <input id="FiltrarContenido" type="text" class="form-control" placeholder="BUSCAR ALUMNO" aria-label="Alumno" aria-describedby="basic-addon1">
        </div>
