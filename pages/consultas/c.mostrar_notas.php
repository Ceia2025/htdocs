...
<head>
    ...
    <style>
    /* Aplica fondo blanco al contenedor de la tabla */
    .table-container {
    ...
    /* Aplica fondo blanco a la tabla completa */
    .table {
        background-color: white !important; /* Fuerza fondo blanco */
    ...
    /* Aplica fondo blanco a las celdas de la tabla */
    .table th, .table td {
        background-color: white !important; /* Fuerza fondo blanco */
        color: black; /* Asegura el texto en negro */
        border: 1px solid #ddd; /* Opcional: bordes grises */
        padding: 10px;
    }

    /* Fondo blanco para filas de cuerpo */
    .table tbody tr {
        background-color: white !important; /* Fondo blanco */
    }

    /* Opcional: Asegura contraste en encabezados */
    .table th {
        font-weight: bold;
        text-align: center;
    }
    ...
    .table td.alumno {
        ...
        .nota-roja {
            ...
            font-size: 0.9em;  /* Tamaño más grande */
        }
        .nota-azul {
            color: blue;
            font-weight: bold; /* Negrita */
  ...
  /* Aplica un tamaño de fuente más pequeño solo a los nombres de los alumnos */
  .alumno-nombre {
        font-size: 0.9em; /* Ajusta el tamaño según tus necesidades */
    }
    </style>
</head>
<body>
<div class="container-fluid mt-5">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['curso']) && !empty($_POST['asignatura'])) {
        ...
        if ($result_estudiantes->num_rows > 0) {
            ...
            echo '<div class="table-container">'; // Envolver la tabla con este div
            echo '<table class="table table-bordered table-striped">';
            echo '<thead>';

            echo '<tr>';
            echo '<tr><th class="alumno">Alumnos</th>';
            ...
            while ($row_estudiante = $result_estudiantes->fetch_assoc()) {
                ...
                echo '<tr>';
                echo "<td class='alumno-nombre'>$nombre_completo</td>";
