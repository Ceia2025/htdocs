...
<!--  boton volver                  <input type="button" class="btn btn-primary" class="bi bi-arrow-repeat" value="Actualizar" class="bi bi-arrow-repeat" name="actualizar" id="actualizar" onclick="habilitarCampos()">
                                        </div>
