...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Asignar Docente a Asignatura</h2>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <form action="asignar_docente_asignatura.php" method="post" class="mt-4">
                    <div class="mb-3">
                        <label for="docente_id" class="form-label">Docente</label>
                        <select class="form-select" id="docente_id" name="docente_id" required>
                            <?php
                            
                            $sql = "SELECT id, CONCAT(nombre, ' ', apellido) AS nombre_completo FROM docentes";
                    ...
                    <button type="submit" class="btn btn-primary w-100">Asignar Docente a Asignatura</button>
                </form>
            </div>
        </div>
    </div>
