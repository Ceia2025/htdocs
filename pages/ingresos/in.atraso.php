...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <p></p>
        <p></p>
            <i class="bi bi-clock icon-header"></i>
            
            <span class="highlighted-text">REGISTRO DE ATRASOS</span>
        </h3>
                ...
                <?php foreach ($queryData as $row): ?>
                    <tr>
                        ...
                        <td align="center" valign="middle">
                            <a href="#atraso_<?php echo $row['run']; ?>" data-bs-toggle="modal" class="btn btn-success btn-sm">
                                <i class="bi bi-clock"></i> Registrar
                            </a>
                            <?php include('in.atrasoregistro.php'); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
