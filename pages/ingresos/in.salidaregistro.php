...
<div class="modal fade" id="salida_<?php echo $row['run']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
   	  <div class="modal-content">
            <div class="modal-header">
                <center><h4 class="modal-title" id="myModalLabel">SALIDA</h4></center>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
				<div class="container-fluid">
					<form method="POST" action="in.salidaguardar.php?id=<?php echo $row['run']; ?>">
					...
					<input type="hidden" name="run" value="<?php echo $row['run']; ?>">
						...
						<div class="row form-group">
							...
							<div class="col-sm-10">
							<textarea rows="5" class="form-control" name="jsalida" value="" step="any" placeholder="Ingrese justificación"> </textarea>
                                <p></p>
                            </div>
                        </div>
						...
						<div class="row form-group">
							...
							<div class="col-sm-10">
                                <input type="date" class="form-control" name="fsalida" value="<?php echo date('Y-m-d'); ?>">
						...
						<div class="row form-group">
							...
							<div class="col-sm-10">
							<input type="time" class="form-control"  name="hsalida" value="<?php ini_set('date.timezone' , 'America/Santiago');
			...
			<div class="modal-footer">
				<button type="submit" name="salida" class="btn btn-success"onclick="return confirm('¿Desea guardar este registro?')"><span class="glyphicon glyphicon-check"></span> Guardar</button>
