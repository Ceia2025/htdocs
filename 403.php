...
<body>
    ...
    <img src="/img/logo_saat.jpg" alt="Logo SAAT" class="logo">
        <div class="text-center">
            ...
            <h1 class="display-4 text-danger">Error 403</h1>
            <h1 class="display-8 text-danger">Acceso Denegado</h1>
            <p class="lead">Lo sentimos, no tienes permiso para acceder a esta página.</p>
            
<!-- Icono de advertencia con movimiento -->
<div class="my-4 text-center">
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" 
         class="bi bi-exclamation-triangle text-danger bounce-animation" viewBox="0 0 16 16">
