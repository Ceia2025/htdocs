...
class AntecedenteEscolar
{
    ...
    public function create($data)
    {
        ...
        alumno_id, procedencia_colegio, comuna, ultimo_curso, ultimo_anio_cursado, cursos_repetidos,
        pertenece_20, informe_20, embarazo, semanas, info_salud, eva_psico,
        prob_apren, pie, chile_solidario, chile_solidario_cual,
        fonasa, grupo_fonasa, isapre, seguro_salud
    ) VALUES (
        :alumno_id, :procedencia_colegio, :comuna, :ultimo_curso, :ultimo_anio_cursado, :cursos_repetidos,
        :pertenece_20, :informe_20, :embarazo, :semanas, :info_salud, :eva_psico,
        :prob_apren, :pie, :chile_solidario, :chile_solidario_cual,
        ...
        return $stmt->execute([
            ...
            ':pertenece_20' => $data['pertenece_20'] ?? null,
            ':informe_20' => $data['informe_20'] ?? null,
            ...
            ':pie' => $data['pie'] ?? null,
            ':chile_solidario' => $data['chile_solidario'] ?? null,
