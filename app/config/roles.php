...
return [
    ...
    // ── ALUMNOS ──
    'alumnos'               => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    ...
    'alumno_profile'        => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    'alumno_search'         => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    ...
    'alumno_pdf'            => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO],
    ...
    // ── MATRÍCULAS ──
    'matriculas'        => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO],
    ...
    // ── ANOTACIONES ──
    'anotaciones'               => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    'anotacion_create'          => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    'anotacion_store'           => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    'anotacion_ver'             => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    'anotacion_delete'          => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL],
    'anotacion_buscar_alumno'   => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES],
    ...
    'libro_clases'              => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_DIRECCION, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    ...
    'atrasos_buscar_alumno'     => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ATRASOS],
