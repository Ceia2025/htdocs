...
return [
    ...
    'alumno_update' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    ...
    'alumno_search_ajax_matricula' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    ...
    // ── ANTECEDENTES ──
    'alum_emergencia' => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_create' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_store' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_edit' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_update' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_delete' => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_createProfile' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_storeProfile' => [ROL_ADMINISTRADOR, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
    'alum_emergencia_deleteProfile' => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL],
    'alumno_search_ajax' => [ROL_ADMINISTRADOR, ROL_SOPORTE, ROL_ADMINISTRATIVO, ROL_INSPECTOR_GENERAL],
