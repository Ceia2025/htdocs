...
return [
    ...
    // ── RETIROS ──
    'retiros' => [ROL_ADMINISTRADOR,ROL_INSPECTOR_GENERAL],
    'retiros_create' => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL],
    ...
    'retiros_reporte' => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL],
];