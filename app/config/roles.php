...
return [
    ...
    'anotacion_create'          => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENTE_SOCIAL, ROL_ANOTACIONES, ROL_DOCENTE],
    ...
    'guardar_asistencia_masiva' => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENCIAS, ROL_ADMINISTRATIVO, ROL_DOCENTE],
    ...
    'asistencia_edit'           => [ROL_ADMINISTRADOR, ROL_INSPECTOR_GENERAL, ROL_ASISTENCIAS, ROL_ADMINISTRATIVO, ROL_DOCENTE],
