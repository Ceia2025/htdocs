...
// ── Valores ENUM — deben coincidir EXACTAMENTE con el schema ──────────────────
$cursos = [
    '1ro basico',
    '2do basico',
    '3ro basico',
        ...
        <div class="bg-gray-700 p-8 rounded-2xl shadow-lg">
            ...
            <form method="POST" action="index.php?action=antecedente_escolar_updateProfile" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="ultimo_curso"
                            ...
                            <?php foreach ($cursos as $c): ?>
                                <option value="<?= $c ?>" <?= sel($antecedente['ultimo_curso'] ?? '', $c) ?>><?= $c ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <!-- EMBARAZO — solo si es mujer (TINYINT) -->
                    <?php if ($esMujer): ?>
                        <div>
                    ...
                    <!-- Problemas de aprendizaje — ENUM con opción vacía -->
                    <div>
                    ...
                    <!-- Tipo Chile Solidario — ENUM con opción vacía -->
                    <div>
                        ...
                        <select name="chile_solidario_cual"
                            ...
                            <option value="">Seleccionar...</option>
                            <?php foreach ($cs as $v): ?>
                                <option value="<?= $v ?>" <?= sel($antecedente['chile_solidario_cual'] ?? '', $v) ?>>
                                    <?= $v ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="grupo_fonasa"
                            ...
                            <option value="">Seleccionar...</option>
                            <?php foreach ($gf as $g): ?>
                                <option value="<?= $g ?>" <?= sel($antecedente['grupo_fonasa'] ?? '', $g) ?>><?= $g ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <!-- Isapre — ENUM con opción vacía -->
                    <div>
                    ...
                    <!-- Información de Salud — VARCHAR(200) -->
                    ...
                    <!-- Evaluación Psicológica — VARCHAR(80) 
                    <div class="md:col-span-2">
