        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-center">
                ...
                <div class="bg-gray-700 p-8 rounded-2xl shadow-lg w-full max-w-lg">
                    ...
                    <form method="post" action="index.php?action=matricula_update&id=<?= $matricula['id'] ?>"
                        class="space-y-6">
                        ...
                        <!-- Fecha de matrícula -->
                        <div>
                            <label for="fecha_matricula" class="block text-sm font-medium text-gray-200">Fecha de
                                Matrícula</label>
                            <input type="date" name="fecha_matricula" id="fecha_matricula" max="<?= date('Y-m-d') ?>"
                                value="<?= !empty($matricula['fecha_matricula']) ? $matricula['fecha_matricula'] : '' ?>"
                                class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                        </div>
