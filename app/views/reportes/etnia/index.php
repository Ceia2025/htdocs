    ...
    <form method="GET" action="index.php" class="panel rounded-xl p-4 mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
            ...
            <div>
                ...
                <select name="etnia" class="input-field w-full text-sm rounded-lg px-3 py-2 cursor-pointer">
                    <option value="">— Todos —</option>
                    <?php foreach ($etnias as $e): ?>
                        <option value="<?= htmlspecialchars($e) ?>" <?= $e === $etniaFiltro ? 'selected' : '' ?>>
                            <?= htmlspecialchars($e) ?>
                        </option>
                    <?php endforeach ?>
                </select>
                                    ...
                                    <?php if ($esPueblo): ?>
                                        <span class="inline-flex items-center gap-1.5">
                                            <span class="w-2 h-2 rounded-full inline-block"
                                                style="background: var(--accent-title);"></span>
