...
/* ── BULLETS ── */
.bullets { margin: 8px 0 10px 30px; }
.bullets li {
    list-style: disc;
    font-style: italic;
    font-size: 11px;
...
.bullets li strong { font-style: normal; }

/* ── TABLA ASISTENCIA ── */
.tabla-wrap { margin: 10px 60px 12px 60px; }
.tabla-asistencia {
    width: 100%;
...
.tabla-asistencia tr:nth-child(even) td { background: #f5f5f5; }
.tabla-asistencia tfoot td {
    border-top: 1px solid #000;
    font-weight: bold;
}
.tabla-asistencia .num { text-align: right; }
...
<div class="page">
    ...
    <?php
    $mesesNombre = [
        1=>'MARZO', 2=>'MARZO', 3=>'MARZO', 4=>'ABRIL', 5=>'MAYO',
    ...
    <ul class="bullets">
        <li>
            ...
            <br><strong>Para los fines que estime conveniente.</strong>
        </li>
    </ul>
