...
<style>
    ...
    .ficha-titulo {
        ...
        background: #d1fae5; color: #047857; font-weight: bold;
    ...
    table.detalle thead tr { background: #065f46; }
...
<div class="header">
    ...
    <div class="header-right">
        ...
        <div class="ficha-titulo">Reporte de Matrícula — <?= htmlspecialchars($anioNombre) ?></div>
    </div>
</div>
...
<div class="info-box">
    ...
    <strong>Matrícula activa:</strong> <?= $resumenGlobal['total_activos'] ?> &nbsp;·&nbsp;
    <strong>% activos:</strong> <?= $resumenGlobal['porcentaje'] ?>% &nbsp;·&nbsp;
    <strong>Generado:</strong> <?= date('d/m/Y H:i') ?>
</div>

<strong style="font-size:10px; color:#047857;">Resumen por curso</strong>
<table class="resumen-global" style="margin-top:4px;">
    <thead>
        <tr>
            <th>Curso</th>
            <th class="tc">Matriculados</th>
            <th class="tc">Activos</th>
            <th class="tc">% Activo</th>
            <th class="tc">Distribución</th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($resumenCursos as $rc):
            $barPx = (int) round($rc['porcentaje'] * 0.8);
        ?>
        <tr>
            <td><?= htmlspecialchars($rc['curso']) ?></td>
            <td class="tc"><?= $rc['total_matriculados'] ?></td>
            <td class="tc" style="font-weight:bold; color:#047857;"><?= $rc['total_activos'] ?></td>
        ...
        <tr style="border-top:2px solid #cbd5e1;">
            ...
            <td class="tc" style="font-weight:bold; color:#047857;"><?= $resumenGlobal['total_activos'] ?></td>
...
<div class="<?= $primero ? '' : 'page-break' ?>">
    ...
    <table class="detalle">
        ...
        <tbody>
            ...
            <tr>
                <td class="tc activo"><?= $al['numero_lista'] ?? '—' ?></td>
