        ...
        <header class="bg-gray-800 border-b border-white/10">
            <div class="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-0.5">Elige un curso para tomar asistencia, ver el resumen o el
                        libro de clases</p>
                </div>
            ...
            <?php else: ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <?php foreach ($cursos as $curso): ?>
                        <div class="animate-fadeIn group bg-gray-800 border border-gray-700 hover:border-indigo-500
                                ...
                                <div class="min-w-0">
                                    ...
                                    <?php if (isset($ultimasFechas[$curso['id']])): ?>
                                        <p class="text-xs text-gray-500 mt-0.5 flex items-center gap-1">
                                            <svg class="w-3 h-3 text-gray-600 flex-shrink-0" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
