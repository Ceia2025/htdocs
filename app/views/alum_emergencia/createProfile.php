    ...
    <main>
        <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-700 p-8 rounded-2xl shadow-lg">
                <form method="POST" action="index.php?action=alum_emergencia_storeProfile" class="space-y-6">

                    <!-- ID del alumno oculto -->
                    <input type="hidden" name="alumno_id" value="<?= htmlspecialchars($alumno_id) ?>">
                    <input type="hidden" name="back" value="alumno_profile">
