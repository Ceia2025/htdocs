...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-top span { margin-right: 20px; }
        ...
        .section-body { padding: 6px 10px 8px 10px; }
        ...
        .grid-3 td:not(:first-child) { padding-left: 10px; }
        ...
        .grid-2 td:not(:first-child) { padding-left: 10px; }

        /* ── FILA DE DATO ── */
        .dato { margin-bottom: 3px; line-height: 1.5; }
        .lbl {
            font-weight: bold;
            color: #004b8d;
            display: inline;
        ...
        .simple-table tr:nth-child(even) td { background: #f8fafc; }
        ...
        .badge-retirado { background: #fee2e2; color: #991b1b; border: 1px solid #fca5a5; }
        ...
        <table class="grid-3">
            <tr>
                ...
                <td>
                    ...
                    <div class="dato"><span class="lbl">RUN:</span> <?= v($alumno,'run') . '-' . v($alumno,'codver','') ?></div>
                    ...
                    <div class="dato"><span class="lbl">Edad (30/06):</span>
                        <?= $edadAl30Junio !== null ? $edadAl30Junio . ' años' : 'No registrada' ?>
                    </div>
                    <div class="dato"><span class="lbl">Sexo:</span> <?= v($alumno,'sexo') ?></div>
                    <div class="dato"><span class="lbl">Nacionalidad:</span> <?= v($alumno,'nacionalidades') ?></div>
                    <div class="dato"><span class="lbl">Etnia:</span> <?= v($alumno,'cod_etnia') ?></div>
                </td>
                ...
                <td>
                    ...
                    <div class="dato"><span class="lbl">Fecha Retiro:</span> <?= v($alumno,'deleted_at','No registra') ?></div>
                    <div class="dato"><span class="lbl">Mayor de Edad:</span> <?= v($alumno,'mayoredad','No') ?></div>
            ...
            <table class="grid-2">
                <tr>
                    <td>
                        ...
                        <div class="dato"><span class="lbl">Nivel / Ciclo:</span> <?= v($familiarData,'nivel_ciclo_p') ?></div>
                    </td>
                    <td>
                        <div class="sub-titulo">Madre</div>
                        <div class="dato"><span class="lbl">Escolaridad:</span> <?= v($familiarData,'madre') ?></div>
                        <div class="dato"><span class="lbl">Nivel / Ciclo:</span> <?= v($familiarData,'nivel_ciclo_m') ?></div>
                    </td>
                </tr>
            </table>
        <?php else: ?>
            ...
            <table class="grid-2">
                <tr>
                    ...
                    <td>
                        ...
                        <div class="dato"><span class="lbl">Procedencia:</span> <?= v($escolarData,'procedencia_colegio') ?></div>
                        <div class="dato"><span class="lbl">Comuna:</span> <?= v($escolarData,'comuna') ?></div>
                        <div class="dato"><span class="lbl">Último curso:</span> <?= v($escolarData,'ultimo_curso') ?></div>
                        <div class="dato"><span class="lbl">Último año:</span> <?= v($escolarData,'ultimo_anio_cursado') ?></div>
                        <div class="dato"><span class="lbl">Cursos repetidos:</span> <?= v($escolarData,'cursos_repetidos','0') ?></div>
                        <div class="dato"><span class="lbl">Eval. psicológica:</span> <?= v($escolarData,'eva_psico','No registrada') ?></div>
                        <div class="dato"><span class="lbl">Info. salud:</span> <?= v($escolarData,'info_salud','No registrada') ?></div>
                    </td>

                    <!-- Col der: condiciones -->
                    <td>
                        <div class="sub-titulo">Condiciones y Programas</div>
                        <div class="dato"><span class="lbl">Pertenece al 20%:</span> <?= siNo($escolarData['pertenece_20'] ?? 0) ?></div>
                        <div class="dato"><span class="lbl">Informe 20%:</span> <?= siNo($escolarData['informe_20'] ?? 0) ?></div>
                        <div class="dato"><span class="lbl">Embarazo:</span>
                            <?= ($escolarData['embarazo'] ?? 0)
                                ? 'Sí (' . v($escolarData,'semanas','-') . ' semanas)'
                                : 'No' ?>
                        </div>
                        <div class="dato"><span class="lbl">Prob. aprendizaje:</span> <?= v($escolarData,'prob_apren') ?></div>
                        ...
                        <div class="dato"><span class="lbl">Grupo Fonasa:</span> <?= v($escolarData,'grupo_fonasa','No registra') ?></div>
                        <div class="dato"><span class="lbl">Isapre:</span> <?= v($escolarData,'isapre','No registra') ?></div>
                        <div class="dato"><span class="lbl">Seguro salud:</span> <?= v($escolarData,'seguro_salud','No registra') ?></div>
                    </td>
                </tr>
            </table>
        <?php else: ?>
