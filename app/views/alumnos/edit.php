        ...
        <div class="bg-gray-700 p-8 rounded-2xl shadow-lg">
            <form action="index.php?action=alumno_update&id=<?= $alumno['id'] ?>" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="run" value="<?= htmlspecialchars($alumno['run']) ?>" required class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-3 py-2 
                ...
                <div>
                    ...
                    <input type="text" name="codver" value="<?= htmlspecialchars($alumno['codver']) ?>" required class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-3 py-2 
                                focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                </div>
