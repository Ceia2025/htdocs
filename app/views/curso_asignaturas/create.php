    ...
    <div class="min-h-full">
        ...
        <header
            ...
            <div class="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white">Nueva Relación Curso - Asignatura</h1>
            </div>
        </header>
        ...
        <main>
            <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="bg-gray-700 p-8 rounded-2xl shadow-lg">
                    <form action="index.php?action=curso_asignaturas_store" method="post" class="space-y-6">
