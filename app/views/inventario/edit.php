    ...
    <main>
        <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-700 p-8 rounded-2xl shadow-lg">
                <form method="POST" action="index.php?action=inventario_update&id=<?= $item['id'] ?>" class="space-y-6">
                    ...
                    <!-- Individualización -->
                    <div>
                        <label for="individualizacion_id" class="block text-sm font-medium text-gray-200">Individualización</label>
                        <select name="individualizacion_id" id="individualizacion_id" required
                            ...
                            <?php foreach ($individualizaciones as $ind): ?>
                                <option value="<?= $ind['id'] ?>" <?= ($ind['id'] == $item['individualizacion_id']) ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($ind['descripcion']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <!-- Categorización -->
                    <div>
                        <label for="categorizacion_id" class="block text-sm font-medium text-gray-200">Categorización</label>
                    ...
                    <!-- Estado -->
                    <div>
                        <label for="estado_id" class="block text-sm font-medium text-gray-200">Estado de Conservación</label>
                    ...
                    <div>
                        ...
                        <input type="text" name="codigo_general" id="codigo_general"
                            value="<?= htmlspecialchars($item['codigo_general']) ?>" required
                            class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="codigo_especifico" id="codigo_especifico" min="1"
                            value="<?= htmlspecialchars($item['codigo_especifico']) ?>" required
                            class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
