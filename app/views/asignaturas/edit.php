                    ...
                    <form method="POST" action="index.php?action=asignatura_update&id=<?= $asignatura['id'] ?>" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="descp" rows="4" required
                                class="mt-2 w-full rounded-lg bg-gray-800 border border-gray-700 text-white px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none"><?= htmlspecialchars($asignatura['descp']) ?></textarea>
                        </div>
