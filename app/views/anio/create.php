    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
                <form method="post" action="index.php?action=anio_store" class="space-y-6">
                    ...
                    <div class="bg-gray-800 border border-gray-700 rounded-2xl p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="anio" required min="2020" max="2099" placeholder="Ej: 2026"
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" rows="2" class="w-full rounded-xl bg-gray-900/60 border border-gray-700 text-gray-100 
                                   px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition resize-none"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-800 border border-gray-700 rounded-2xl p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="sem1_inicio" class="w-full rounded-xl bg-gray-900/60 border border-gray-700 text-gray-100 
                                           px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition">
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-400 mb-1">Fecha de Término</label>
                                    <input type="date" name="sem1_fin" class="w-full rounded-xl bg-gray-900/60 border border-gray-700 text-gray-100 
                                           px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-xs text-gray-400 mb-1">Fecha de Inicio</label>
                                    <input type="date" name="sem2_inicio" class="w-full rounded-xl bg-gray-900/60 border border-gray-700 text-gray-100 
                                           px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition">
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-400 mb-1">Fecha de Término</label>
                                    <input type="date" name="sem2_fin" class="w-full rounded-xl bg-gray-900/60 border border-gray-700 text-gray-100 
                                           px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition">
                                </div>
                            </div>
                        </div>
