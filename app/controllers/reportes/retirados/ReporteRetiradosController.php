<?php
require_once __DIR__ . '/../../../models/reportes/retirados/ReporteRetirados.php';
...
class ReporteRetiradosController
{
    private ReporteRetirados $model;

    public function __construct()
    {
        $this->model = new ReporteRetirados();
    }
    ...
    public function index()
    {
        ...
        $reporte       = [];
        $resumenCursos = [];
        $resumenGlobal = ['total_matriculados' => 0, 'total_retirados' => 0, 'porcentaje' => 0.0];
        ...
        require __DIR__ . '/../../../views/reportes/retirados/reportesRetirados.php';
    }

    /* ==========================================
       EXPORTAR PDF
    ========================================== */
    public function pdfRetirados()
    {
        ...
        ob_start();
        require __DIR__ . '/../../../views/reportes/retirados/reportesRetirados_pdf.php';
        $html = ob_get_clean();

        $slug = $cursoId ? $cursoNombre : 'General';
        $this->generarPDF($html, "ReporteRetirados_{$slug}_{$anioNombre}.pdf");
    }
